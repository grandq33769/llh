# The replay buffer class is responsible for storing transitions.  These transitions will be used for the
# minibatch updates to the Q-function neural network.  They allow the neural network to train with
# transitions that are IID, independent and identically distributed.
